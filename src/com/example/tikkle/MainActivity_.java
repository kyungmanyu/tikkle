...
public class MainActivity_ extends Activity implements OnKeyListener {
	...
	public void onItemClick(int mPosition) {
		...
		Intent i = new Intent(MainActivity_.this, DetailActivity.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_settings) {
			Intent i = new Intent(MainActivity_.this, Mypage.class);
